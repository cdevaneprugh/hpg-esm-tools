#!/bin/bash
#SBATCH --job-name=area-frac-diag
#SBATCH --output=logs/area_frac_diag_%j.log
...
echo "=== Area Fraction Diagnostic Investigation ==="
echo "Date: $(date)"
...
python scripts/merit_validation/area_fraction_diagnostics.py
