...
| `hill_area` | `sum(water_mask) * pixel_area` ≈ 11.08 km² | Total NWI lake area from the water mask. Production domain (c260505, post-E.6): 103 features, 11,082,394 pixels. Defines fractional area of lake column within gridcell. |
